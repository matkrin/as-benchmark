(module
 ...
 (data (i32.const 848) "\t\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\t\00\00\02\00\00\00\01\1a\00\00\02\00\00\00\81\00\00\00\02\00\00\00$\1a\00\00\00\00\00\00\04A\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>>#get:length (param $0 i32) (result i32)
  local.get $0
  i32.const 20
  i32.sub
  i32.load offset=16
 ...
 (func $assembly/index/hypotenuse (param $0 f64) (param $1 f64) (result f64)
  (local $2 f64)
  (local $3 f64)
  f64.const 0
  local.set $2
 ...
 (func $assembly/index/QrResult#set:qr (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/index/QrResult#set:rdiag (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
  local.get $0
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
         ...
         block $~lib/arraybuffer/ArrayBufferView
          block $~lib/string/String
           block $~lib/arraybuffer/ArrayBuffer
            ...
            i32.sub
            i32.load
            br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/typedarray/Int32Array $~lib/typedarray/Float64Array $~lib/typedarray/Uint16Array $~lib/staticarray/StaticArray<f64> $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>> $assembly/index/QrResult $invalid
           end
           return
          end
          return
   ...
   local.get $0
   local.get $1
   call $assembly/index/QrResult~visit
   return
  end
  unreachable
 )
 ...
 (func $assembly/index/createMatrix (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/index/createCoefficientMatrix (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/cloneMatrix (param $0 i32) (result i32)
  ...
  i32.store offset=8
  local.get $0
  call $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>>#get:length
  local.set $1
  local.get $0
  i32.const 0
  call $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>>#__uget
 ...
 (func $assembly/index/qrDecomposition (param $0 i32) (result i32)
   ...
   if
    ...
    loop $for-loop|1
     ...
     if
      ...
      local.get $7
      call $~lib/staticarray/StaticArray<f64>#__uget
      call $assembly/index/hypotenuse
      local.set $10
      local.get $5
      i32.const 1
      i32.add
  ...
  global.get $~lib/memory/__stack_pointer
  i32.const 0
  call $assembly/index/QrResult#constructor
  local.tee $9
  i32.store offset=16
  local.get $9
  local.get $1
  call $assembly/index/QrResult#set:qr
  local.get $9
  local.get $4
  call $assembly/index/QrResult#set:rdiag
  local.get $9
  local.set $13
  global.get $~lib/memory/__stack_pointer
  i32.const 20
 ...
 (func $assembly/index/subMatrix (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
 ...
 (func $assembly/index/matrixToFloat64Array (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/index/wasmLeastSquares (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  i32.mul
  i32.const 1
  call $assembly/index/createMatrix
  local.tee $3
  i32.store
  global.get $~lib/memory/__stack_pointer
  local.get $1
   ...
   if
    ...
    loop $for-loop|1
     ...
     if
      ...
      local.get $6
      local.get $14
      call $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>>#__get
      local.set $19
      global.get $~lib/memory/__stack_pointer
      local.get $19
      i32.store offset=20
  ...
  i32.const 1
  i32.sub
  call $assembly/index/subMatrix
  local.tee $16
  i32.store offset=32
  local.get $16
  call $assembly/index/matrixToFloat64Array
  local.set $19
  global.get $~lib/memory/__stack_pointer
  i32.const 36
  i32.add
 ...
 (func $assembly/index/QrResult#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $~lib/staticarray/StaticArray<~lib/staticarray/StaticArray<f64>>#__get (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
